...
def _load(name: str):
    # Via conftest so the shared name is RESTORED afterwards. Registering it and
    # walking away made this module's private copy everyone's copy for the rest
    # of the session, which silently defeated a monkeypatch in another file.
